    ...
    <div className="flex flex-col">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-secondary">
        <div className="container grid items-center justify-between gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
          ...
          <Image
            src="https://media.licdn.com/dms/image/v2/D4D22AQH-WbqRNuC1vw/feedshare-shrink_800/feedshare-shrink_800/0/1723688096390?e=2147483647&v=beta&t=d5Xe5xvqhXyjV_3YO4ROGYDJ1cNeaBv5qDpBt5mRQVE"
